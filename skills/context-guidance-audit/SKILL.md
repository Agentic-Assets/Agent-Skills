...
- Replace brittle fixed counts with **pointers to canonical helpers** or modules.
- Replace non-existent skill/agent names with **installed** paths (search skill and agent directories on disk).
